...
TEXT_TEMPLATE_FILENAME = "appendix_a.html.jinja"
...
class AppendixAChapter(SiteChapter):
    """
    ...
    def from_json(cls, json_path, name, dir, index):
        ...
        for exc_elem_path, artifacts_obj in sorted_data.items():
